            ...
            <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" id="actual_minutes" name="actual_minutes" class="form-control @error('actual_minutes') is-invalid @enderror" value="{{ old('actual_minutes', $task->actual_minutes) }}" min="0">

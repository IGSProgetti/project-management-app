    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="password">Password (lasciare vuoto per mantenere invariata)</label>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="resource_id" name="resource_id" class="form-select @error('resource_id') is-invalid @enderror">
                            ...
                            @foreach($availableResources as $resource)
                                <option value="{{ $resource->id }}" {{ old('resource_id', $user->resource_id) == $resource->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="{{ route('users.show', $user->id) }}" class="btn btn-secondary">Annulla</a>
                    </div>
                </div>
            </form>
        </div>
